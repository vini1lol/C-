...
public:
    ...
    double heuristica(Coord a);
    inline double getF()const {return g+h;}

    inline bool operator==(Coord a){return pos==a;}
    inline bool operator!=(Coord a){return !operator==(a);}
    inline bool operator==(Noh n){return pos==n.pos;}
    inline bool operator<(Noh n){return ((g<n.g) && (h<n.h));}
